...
<head>
    ...
    <title>Sign In | SIAKAD Untad</title>
    ...
    <div class="min-h-screen flex items-center justify-center p-4">
        <div class="w-full max-w-md fade-in">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-400">Sign in to your SIAKAD account</p>
            </div>
            ...
            <div class="glass-card rounded-2xl p-8">
                <form action="{{ route('auth.authenticate') }}" method="POST" class="space-y-6">
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center">
                            <input type="checkbox" class="w-4 h-4 text-emerald-600 bg-transparent border-gray-600 rounded focus:ring-emerald-500 focus:ring-2">
                ...
                <div class="mt-8 pt-6 border-t border-gray-700">
                    <p class="text-center text-gray-400">
                        ...
                        <a href="{{ route('auth.register') }}" class="text-emerald-400 hover:text-emerald-300 font-medium transition-colors">
                            Create Account
                        </a>
                    </p>
                </div>
