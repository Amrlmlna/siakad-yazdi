...
<div class="min-h-screen p-8">
    ...
    <div class="mb-8">
        <div class="flex items-center gap-4 mb-4">
            <div class="w-12 h-12 primary-gradient rounded-lg flex items-center justify-center luxury-shadow">
                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                </svg>
            </div>
            <div>
                <h1 class="text-3xl font-playfair font-bold bg-gradient-to-r from-blue-300 via-blue-400 to-blue-500 bg-clip-text text-transparent">
                    Data Absensi
                </h1>
    ...
    <!-- Main Content Card -->
    <div class="glass-effect rounded-2xl p-8 shadow-lg border border-slate-700/50">
        <!-- Table Header -->
        <div class="mb-6">
            <h2 class="text-xl font-semibold text-blue-300 mb-2">Daftar Kelas</h2>
                ...
                <table class="w-full">
                    <thead class="bg-slate-700/70">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-center text-xs font-medium text-blue-300 uppercase tracking-wider">
                    ...
                    <tbody class="divide-y divide-slate-600/50">
                        ...
                        <tr class="hover:bg-slate-700/30 transition-all duration-300 group">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="w-8 h-8 primary-gradient rounded-full flex items-center justify-center text-white text-sm font-bold luxury-shadow">
                                    {{ $loop->iteration }}
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                ...
                                <div class="flex items-center justify-center gap-3">
                                    <a href="{{ route('dosen.absensi.create', ['kelas_id' => $a->jadwal->kelas->id]) }}" 
                                       class="group/btn inline-flex items-center gap-2 primary-gradient hover:scale-105 text-white px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 luxury-shadow">
                                    ...
                                    <a href="{{ route('dosen.absensi.edit', ['kelas_id' => $a->jadwal->kelas->id]) }}" 
                                       class="group/btn inline-flex items-center gap-2 secondary-gradient hover:scale-105 text-white px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 luxury-shadow">
                                        <svg class="w-4 h-4 group-hover/btn:rotate-12 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
