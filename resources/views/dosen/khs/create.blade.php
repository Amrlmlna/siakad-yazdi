...
<div class="container">
    ...
    <!-- Main Content Card -->
    <div class="bg-glass-card rounded-xl p-6 mb-6">
        <form action="{{ route('dosen.khs.store') }}" method="POST">
            @csrf
            
            <!-- Class Info Header -->
            <div class="mb-8 p-6 bg-glass-card rounded-xl border border-red-500/20">
                    ...
                    <table class="w-full text-white">
                        <thead class="bg-secondary">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-left text-xs font-medium uppercase tracking-wider">Nama Mahasiswa</th>
                                <th class="px-6 py-4 text-left text-xs font-medium uppercase tracking-wider">NIM</th>
                                <th class="px-6 py-4 text-left text-xs font-medium uppercase tracking-wider">Nilai</th>
                            </tr>
                        </thead>
                            ...
                            <tr class="hover:bg-gray-700/30 transition-all duration-300">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="font-medium">{{ $k->mahasiswa->nama ?? '-' }}</p>
                                            <p class="text-gray-400 text-sm">Mahasiswa</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="font-mono bg-gray-700/50 px-3 py-1 rounded-lg inline-block">
                                        {{ $k->mahasiswa->nim ?? '-' }}
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <select name="nilai[]" 
                                            class="bg-glass-input border border-gray-700 rounded-lg px-4 py-2 text-white focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all duration-300 min-w-[120px]" required>
            ...
            <div class="flex justify-center">
                <button type="submit" 
                        class="btn-primary hover:scale-105 flex items-center gap-3 text-lg">
